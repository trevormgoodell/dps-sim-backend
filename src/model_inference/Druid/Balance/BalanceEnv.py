...
try:
    from Druid.Balance.BalanceSpells import *
except:
    print("Druid module not found in agent")
...
class BalanceDruidEnvironment(GeneralEnvironment):
    def __init__(self, haste, critical_strike, versatility, mastery, main_stat):
        ...
        self.actions[Spells.RAVENOUS_FRENZY] = RavenousFrenzy()
        self.actions[Spells.ORB] = Orb()
